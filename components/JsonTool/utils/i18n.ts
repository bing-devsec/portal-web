export const SETTINGS_TXT_ZH = {
    ...
    fontSizeTitleValue: (px: number) => `字体 ${px}px`,
    fontSizeStaticDesc: '调整 JSON 编辑器中代码与文字的显示字号',
    indentTitle: '缩进空格',
    indentTitleValue: (n: number) => `缩进 ${n} 空格`,
    indentStaticDesc: '控制 JSON 格式化时每一级缩进所占的空格数',
    wordWrapTitle: '换行显示',
    wordWrapTitleOn: '已开启换行',
    wordWrapTitleOff: '已关闭换行',
    wordWrapStaticDesc: '当一行内容超出编辑器宽度时，自动折行显示，避免出现横向滚动条',
    wordWrapDescOn: '超长字符串、超长数字等在一行显示',
    wordWrapDescOff: '超长字符串、超长数字等换行显示',
    wordWrapOn: '换行',
    wordWrapOff: '不换行',
    fullscreenTitle: '是否默认全屏',
    fullscreenTitleOn: '默认全屏打开',
    fullscreenTitleOff: '默认正常打开',
    fullscreenStaticDesc: '打开页面时直接进入全屏编辑模式，自动隐藏顶部导航与侧边栏',
    fullscreenDesc: '开启后页面将在加载时自动进入全屏编辑模式',
    fullscreenOn: '全屏',
    fullscreenOff: '非全屏',
    diagnosticsTitle: '语法检查',
    diagnosticsTitleOn: '实时校验',
    diagnosticsTitleOff: '不校验',
    diagnosticsStaticDesc: '编辑过程中实时检测 JSON 语法错误，并以红色波浪线标注问题位置',
    diagnosticsDesc: '关闭后编辑区域将不再显示红色波浪线报错提示，但语法高亮仍生效',
    diagnosticsOn: '启用',
    diagnosticsOff: '禁用',
    stickyScrollTitle: '粘性滚动设置',
    stickyScrollTitleOn: '已开启粘性滚动',
    stickyScrollTitleOff: '已关闭粘性滚动',
    stickyScrollStaticDesc: '向下滚动时，将当前所在的父级字段名固定在编辑器顶部，便于追踪嵌套层级',
    stickyScrollDesc: '开启后编辑器顶部将显示当前光标位置的层级路径，方便查看大JSON时快速了解上级结构',
    stickyScrollOn: '启用',
    stickyScrollOff: '禁用',
    syncScrollTitle: '同步滚动设置',
    syncScrollTitleOn: '同步滚动',
    syncScrollTitleOff: '独立滚动',
    syncScrollStaticDesc: '滚动输入区或输出区时，另一侧自动同步到相同位置，便于左右对照查看',
    syncScrollDesc: '开启后编辑区域和预览区域将同步滚动，便于对照查看原始数据和输出结果',
    syncScrollOn: '启用',
    syncScrollOff: '禁用',
    minimapTitle: '缩略图设置',
    minimapTitleOn: '显示缩略图',
    minimapTitleOff: '隐藏缩略图',
    minimapStaticDesc: '在编辑器右侧显示代码全景缩略图，可拖动定位，方便在大文件中快速跳转',
    minimapDesc: '开启后在编辑器右侧显示代码缩略图，可快速定位和浏览大文件内容',
    minimapOn: '显示',
    minimapOff: '隐藏',
    indentGuideTitle: '缩进指南线设置',
    indentGuideTitleOn: '显示缩进指南',
    indentGuideTitleOff: '隐藏缩进指南',
    indentGuideStaticDesc: '在每一级缩进处绘制淡灰色的垂直辅助线，更直观地识别代码的嵌套结构',
    indentGuideDesc: '开启后将显示垂直参考线，帮助直观识别代码的嵌套层级结构',
    indentGuideOn: '显示',
    indentGuideOff: '隐藏',
    encodingTitleOn: '已开启自动解码',
    encodingTitleOff: '已关闭自动解码',
    encodingStaticDesc: '自动识别并解码 Unicode 和 Hex 编码（Base64 与 URL 编解码请先双击字符串，再右键菜单选择）',
    arrayStyleTitleOn: '数组换行展示',
    arrayStyleTitleOff: '数组紧凑展示',
    arrayStyleStaticDesc: '紧凑模式仅对简单类型数组（元素全为字符串、数字、布尔或 null）生效，复杂对象数组依旧换行',
    unescapeTitleRecursive: '递归去除转义',
    unescapeTitleShallow: '仅去除外层转义',
    unescapeStaticDesc: '递归模式将剥离所有嵌套层级的反斜杠转义，仅外层模式只处理最外一层字符串',
    sortMethodLabel: '排序方式',
    sortMethodStaticDesc: '决定按何种规则对 JSON 对象的字段或数组元素进行排序',
    sortMethodDictionary: '按字典序',
    sortMethodLength: '按Key长度',
    sortMethodField: '按字段值',
    sortOrderLabel: '排序方向',
    sortOrderStaticDesc: '排序结果以正序（升序）还是倒序（降序）排列',
    sortOrderAsc: '正序（升序）',
    sortOrderDesc: '倒序（降序）',
    ...
    demoTryAgain: '再试一次',
    demoEnd: '结束演示',
    archiveNameTitleCustom: '使用自定义名称',
    archiveNameTitleAuto: '使用自动编号',
    archiveNameStaticDesc: '保存存档时弹出命名输入框；关闭则按时间顺序自动编号，无需手动命名',
    ...
    confirmDeleteArchiveTitle: '删除存档',
    confirmDeleteArchiveContent: (name: string) => `确定要删除存档「${name}」吗？此操作不可恢复`,
    confirmDeleteArchiveBtn: '删除',
    confirmDeleteArchiveCancelBtn: '取消',
    archiveDialogBtnCancel: '取消',
    archiveDialogBtnSave: '保存',
    archiveDialogTitleDefault: '保存存档',
    archiveDialogPlaceholderDefault: '请输入存档名称',
    archiveDialogErrCharLimit: '字符限制：中英文、数字和常见字符（- _ + * / = . :）',
    archiveDialogErrNameDuplicate: '存档名称已存在，请使用其他名称',
    archiveDialogErrNameEmpty: '存档名称不能为空',
    archiveDialogErrCharsAllowed: '合法字符：中英文、数字、连字符（- _）和数学符号（+ * / = . : @ #）',
    msgNoCopyContent: '没有可复制的内容',
    msgCopySuccess: '复制成功',
    msgCopyFail: '复制失败',
    msgCopyFailManual: '复制失败, 请尝试手动复制',
    msgCleared: '已清空',
    msgClearedContent: '已清空内容',
    msgClearFail: '清空内容失败',
    msgFileGetFail: '无法获取文件',
    msgFileNameTooLong: '文件名过长',
    msgFileOnlyJson: '只能上传 JSON 文件',
    msgFileTooLarge: '文件大小不能超过 5 MB',
    msgFileWrongType: '文件类型不正确',
    msgFileReadError: '文件读取出错',
    msgFileReadFail: '文件读取失败',
    msgFileLinesExceed: (lines: number) => `文件内容超过行数限制（共 ${lines} 行）`,
    msgFileIndentDetected: (size: number) => `已检测到 ${size} 格缩进，仅临时调整编辑器显示，全局设置保持不变`,
    msgFileUploadSuccess: '文件上传成功',
    msgFileUploadSuccessLoaded: '文件上传成功，已加载到编辑区域',
    msgFileProcessFail: (err: string) => `文件处理失败: ${err}`,
    msgNoDownloadContent: '没有可下载的内容',
    msgDownloadSuccess: '下载成功',
    msgDownloadFail: '下载失败',
    msgDownloadFailWithErr: (err: string) => `下载失败：${err}`,
...
export const SETTINGS_TXT_EN: SettingsTxt = {
    ...
    fontSizeTitleValue: (px: number) => `Font ${px}px`,
    fontSizeStaticDesc: 'Adjust the display size of code and text in the JSON editor',
    indentTitle: 'Indent Size',
    indentTitleValue: (n: number) => `Indent ${n} spaces`,
    indentStaticDesc: 'Number of spaces used per indentation level when formatting JSON',
    wordWrapTitle: 'Word Wrap',
    wordWrapTitleOn: 'Wrap Enabled',
    wordWrapTitleOff: 'Wrap Disabled',
    wordWrapStaticDesc: 'Long strings exceeding the editor width will wrap to a new line',
    ...
    fullscreenTitleOn: 'Open in Fullscreen',
    fullscreenTitleOff: 'Open Normally',
    fullscreenStaticDesc: 'Whether to enter fullscreen edit mode when the page loads',
    fullscreenDesc: 'When enabled, the page enters fullscreen edit mode on load',
    fullscreenOn: 'Fullscreen',
    fullscreenOff: 'Normal',
    diagnosticsTitle: 'Syntax Validation',
    diagnosticsTitleOn: 'Live Validation',
    diagnosticsTitleOff: 'Validation Off',
    diagnosticsStaticDesc: 'Detect JSON syntax errors while typing and underline them in red',
    ...
    stickyScrollTitleOn: 'Sticky Scroll On',
    stickyScrollTitleOff: 'Sticky Scroll Off',
    stickyScrollStaticDesc: 'Pin the current ancestor field name at the top while scrolling, for easier nesting awareness',
    ...
    syncScrollTitleOn: 'Sync Scroll',
    syncScrollTitleOff: 'Independent Scroll',
    syncScrollStaticDesc: 'When scrolling the input or output pane, the other side scrolls to the same position',
    syncScrollDesc: 'Scroll the Editor and Preview panes together for side-by-side comparison',
    syncScrollOn: 'On',
    syncScrollOff: 'Off',
    minimapTitle: 'Minimap',
    minimapTitleOn: 'Minimap Visible',
    minimapTitleOff: 'Minimap Hidden',
    minimapStaticDesc: 'Show a full-code minimap on the right side of the editor for quick navigation',
    ...
    indentGuideTitleOn: 'Indent Guides Visible',
    indentGuideTitleOff: 'Indent Guides Hidden',
    indentGuideStaticDesc: 'Draw light vertical lines at indent positions to help align nesting levels',
    indentGuideDesc: 'Show vertical reference lines to visualize nesting levels',
    indentGuideOn: 'Show',
    indentGuideOff: 'Hide',
    encodingTitleOn: 'Auto Decode On',
    encodingTitleOff: 'Auto Decode Off',
    encodingStaticDesc: 'Automatically decode Unicode and Hex escapes. For Base64 / URL, double-click the string and use the right-click menu.',
    arrayStyleTitleOn: 'Arrays Wrap to New Line',
    arrayStyleTitleOff: 'Arrays Stay Compact',
    arrayStyleStaticDesc: 'Compact mode only affects arrays of primitives (string / number / boolean / null); arrays of objects still wrap.',
    unescapeTitleRecursive: 'Recursive Unescape',
    unescapeTitleShallow: 'Top-level Only',
    unescapeStaticDesc: 'Recursive mode strips backslash escapes from all nested levels; top-level mode only processes the outermost string.',
    sortMethodLabel: 'Sort By',
    sortMethodStaticDesc: 'Choose the rule used to sort fields of a JSON object or elements of an array',
    sortMethodDictionary: 'Alphabetical',
    sortMethodLength: 'Key length',
    sortMethodField: 'Field value',
    sortOrderLabel: 'Direction',
    sortOrderStaticDesc: 'Whether the result is sorted in ascending or descending order',
    ...
    demoEnd: 'End Demo',
    archiveNameTitleCustom: 'Use Custom Name',
    archiveNameTitleAuto: 'Use Auto Numbering',
    archiveNameStaticDesc: 'When enabled, prompt for a name on every save; otherwise snapshots are auto-numbered chronologically without manual naming',
    ...
    confirmDeleteArchiveTitle: 'Delete Snapshot',
    confirmDeleteArchiveContent: (name: string) => `Are you sure you want to delete the snapshot "${name}"? This action cannot be undone.`,
    confirmDeleteArchiveBtn: 'Delete',
    confirmDeleteArchiveCancelBtn: 'Cancel',
    archiveDialogBtnCancel: 'Cancel',
    archiveDialogBtnSave: 'Save',
    archiveDialogTitleDefault: 'Save Snapshot',
    archiveDialogPlaceholderDefault: 'Enter a snapshot name',
    archiveDialogErrCharLimit: 'Allowed characters: letters, digits and common symbols (- _ + * / = . :)',
    archiveDialogErrNameDuplicate: 'Snapshot name already exists, please use another one',
    archiveDialogErrNameEmpty: 'Snapshot name cannot be empty',
    archiveDialogErrCharsAllowed: 'Allowed characters: letters, digits, hyphens (- _) and math symbols (+ * / = . : @ #)',
    msgNoCopyContent: 'Nothing to copy',
    msgCopySuccess: 'Copied successfully',
    msgCopyFail: 'Copy failed',
    msgCopyFailManual: 'Copy failed, please copy manually',
    msgCleared: 'Cleared',
    msgClearedContent: 'Content cleared',
    msgClearFail: 'Failed to clear content',
    msgFileGetFail: 'Failed to read file',
    msgFileNameTooLong: 'File name is too long',
    msgFileOnlyJson: 'Only JSON files are allowed',
    msgFileTooLarge: 'File size cannot exceed 5 MB',
    msgFileWrongType: 'Invalid file type',
    msgFileReadError: 'Error reading file',
    msgFileReadFail: 'Failed to read file',
    msgFileLinesExceed: (lines: number) => `File exceeds the line limit (${lines} lines)`,
    msgFileIndentDetected: (size: number) => `Detected ${size}-space indentation; editor display adjusted temporarily, global settings unchanged`,
    msgFileUploadSuccess: 'File uploaded successfully',
    msgFileUploadSuccessLoaded: 'File uploaded successfully and loaded into the editor',
    msgFileProcessFail: (err: string) => `File processing failed: ${err}`,
    msgNoDownloadContent: 'Nothing to download',
    msgDownloadSuccess: 'Downloaded successfully',
    msgDownloadFail: 'Download failed',
    msgDownloadFailWithErr: (err: string) => `Download failed: ${err}`,
